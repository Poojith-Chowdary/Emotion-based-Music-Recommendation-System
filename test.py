...
@st.cache_resource
def load_models():
    face_model = tf.keras.models.load_model('D://Projects//Minor Project//CODE//BOB//MoDeLs//face_cnn9.h5')
    audio_model = tf.keras.models.load_model('D://Projects//Minor Project//CODE//BOB//MoDeLs//Emotion_Voice_Detection_Model1.h5')
...
def recommend_songs(emotion):
    ...
    try:
        df = pd.read_csv("D://Projects//Minor Project//CODE//BOB//songs.csv")
...
with col1:
    ...
    if st.session_state.captured_face is not None:
        camera_placeholder.image(st.session_state.captured_face, use_column_width=True)
