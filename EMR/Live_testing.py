...
RATE = 44100
RECORD_SECONDS = 5
WAVE_OUTPUT_FILENAME ="D://Minor Proj//EMR//output.wav" 
...
json_file = open("D://Minor Proj//EMR//model1.json", 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("D://Minor Proj//EMR//Emotion_Voice_Detection_Model1.h5")
#print(loaded_model.summary())
import h5py
f = h5py.File("D://Minor Proj//EMR//Emotion_Voice_Detection_Model1.h5", 'r')
...
# csv file name
filename = "D://Minor Proj//EMR//songs.csv"
